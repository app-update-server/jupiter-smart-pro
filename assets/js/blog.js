...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    function renderSidebar(posts) {
        ...
        sidebarContainer.innerHTML = `
            ...
            <div class="widget widget-sales sticky-offer">
                ...
                <img src="assets/img/hero-img.webp" alt="Box do Júpiter">
                <p style="font-size:0.9rem; color:var(--text-muted);">Organize suas finanças com Júpiter Smart Pro.</p>
    ...
    // 5. Renderiza Post Único (CORRIGIDO BRANDING + SEM ERROS DE SINTAXE)
        ...
        if (post) {
            ...
            postContainer.innerHTML = `
                ...
                <div style="margin-top:50px; padding:30px; background:var(--cause-bg); border-radius:12px; text-align:center; border:1px solid var(--cause-border);">
                    ...
                    <p style="color:var(--text-muted); margin-bottom:20px;">Leve sua organização para o próximo nível com o <strong>Júpiter Smart Pro</strong>.</p>
